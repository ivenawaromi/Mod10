...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('firstName')); ?>" placeholder="Enter First Name">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                                <div class="text-danger">
                                                    <small><?php echo e($massage); ?></small>
                                                </div>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('lastName')); ?>" placeholder="Enter Last Name">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="age" id="age" class="form-control <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('age')); ?>" placeholder="Enter Age">
                                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\framework\modul10\resources\views/employee/index.blade.php ENDPATH**/ ?>